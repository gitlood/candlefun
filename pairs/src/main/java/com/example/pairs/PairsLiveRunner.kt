...
object PairsLiveRunner {
    ...
    private fun configFromEnv(symbolA: String, symbolB: String): PairsConfig {
        ...
        return base.copy(
            ...
            priceTickA = System.getenv("PRICE_TICK_A")?.toDoubleOrNull() ?: base.priceTick,
            priceTickB = System.getenv("PRICE_TICK_B")?.toDoubleOrNull() ?: base.priceTick,
            qtyStepA = System.getenv("QTY_STEP_A")?.toDoubleOrNull() ?: base.qtyStep,
            qtyStepB = System.getenv("QTY_STEP_B")?.toDoubleOrNull() ?: base.qtyStep,
            minQtyA = System.getenv("MIN_QTY_A")?.toDoubleOrNull(),
            minQtyB = System.getenv("MIN_QTY_B")?.toDoubleOrNull(),
            minNotionalA = System.getenv("MIN_NOTIONAL_A")?.toDoubleOrNull(),
            minNotionalB = System.getenv("MIN_NOTIONAL_B")?.toDoubleOrNull(),
