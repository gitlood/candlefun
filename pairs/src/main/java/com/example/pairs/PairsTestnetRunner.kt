...
object PairsTestnetRunner {
    ...
    private fun configFromEnv(
        ...
        return base.copy(
            ...
            minQtyA = filtersA?.minQty ?: System.getenv("MIN_QTY_A")?.toDoubleOrNull(),
            minQtyB = filtersB?.minQty ?: System.getenv("MIN_QTY_B")?.toDoubleOrNull(),
            minNotionalA = filtersA?.minNotional ?: System.getenv("MIN_NOTIONAL_A")?.toDoubleOrNull(),
            minNotionalB = filtersB?.minNotional ?: System.getenv("MIN_NOTIONAL_B")?.toDoubleOrNull(),
