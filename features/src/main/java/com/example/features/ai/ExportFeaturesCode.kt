...
fun main() {
    ...
    val sourcePath = "$rootPath/features/src/main/java"
    val outputPath = "$rootPath/features_module_dump.txt"
    ...
    sourceDir.walkTopDown()
        ...
        .filter { it.name != "ExportFeaturesCode.kt" }
        .sortedBy { it.path }
        .forEach { file ->
    ...
    println("Successfully dumped features module to: $outputPath")
}
