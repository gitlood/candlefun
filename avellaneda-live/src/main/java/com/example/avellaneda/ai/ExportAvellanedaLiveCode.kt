...
fun main() {
    ...
    val sourcePath = "$rootPath/avellaneda-live/src/main/java"
    val outputPath = "$rootPath/avellaneda_live_dump.txt"
    ...
    sourceDir.walkTopDown()
        ...
        .filter { it.name != "ExportAvellanedaLiveCode.kt" }
        .sortedBy { it.path }
        .forEach { file ->
    ...
    println("Successfully dumped avellaneda-live module to: $outputPath")
}
